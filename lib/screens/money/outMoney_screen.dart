...
<<<<<<< HEAD
// ─────────────────────────────────────────────
// Pantalla: Retirar dinero
// ─────────────────────────────────────────────
class OutmoneyScreen extends StatefulWidget {
  const OutmoneyScreen({super.key});

  @override
  State<OutmoneyScreen> createState() => OutmoneyScreenEstado();
}

class OutmoneyScreenEstado extends State<OutmoneyScreen> {
  ...
  void confirmarRetiro() {
    ...
    if (texto.isEmpty) {
      mostrarSnackBar(traducciones.enterWithdrawAmount);
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(traducciones.withdrawTitle),
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                labelText: traducciones.amountToWithdraw,
            ...
            ElevatedButton(
              ...
              onPressed: confirmarRetiro,
              child: Text(traducciones.confirmWithdraw),
            ),
          ],
        ),
      ),
